            ...
            <div class="tabCliente">
                <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
                    ...
                    <ul class="list-inline">
                        <li class="active" ><a id = "1" onclick = "active(this); limpiar();"  style="color: orange; padding-right: 15px" data-toggle="tab" href="#addCliente">AGREGAR CLIENTE</a></li>
                        <li><a style="color: gray; padding-left: 15px" id = "2"  onclick = "activeL(this) limpiar();"  data-toggle="tab" href="#listaClientes">LISTA CLIENTES</a></li>
                    </ul>
                    </div>
