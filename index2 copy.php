            ...
            <div class="tabCliente">
                <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
                    ...
                    <ul class="list-inline">
                        <li class="active" ><a id = "1" onclick = "active(this); changeList(); limpiar();"  style="color: orange; padding-right: 15px" data-toggle="tab" href="#addCliente">AGREGAR CLIENTE</a></li>
