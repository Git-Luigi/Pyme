                            ...
                            <div class="container-fluid" >   
                                ...
                                <div class = "contenido">
                                    ...
                                    <div class="row form-group ">
                                        <label style="color: #154360; font-weight: normal; " class="col-sm-2 col-form-label">Categor&iacute;a *</label>
                                        <div class = " col-sm-3">
                                            <select class="form-control" type="text" id="catProducto" name="categoria">
