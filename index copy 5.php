            ...
            <div class="tabCliente">
                <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
                    <div class="mdl-tabs__tab-bar">
                        <a href="#tabNewCliente" class="mdl-tabs__tab is-active" style ="text-decoration: none;">Agregar Cliente</a>
                        <a href="#tabListCliente" class="mdl-tabs__tab"style ="text-decoration: none;">Lista de Clientes</a>
                    </div>
                    <div class="mdl-tabs__panel is-active" id="tabNewCliente">
                        <form id="client-form">                  
