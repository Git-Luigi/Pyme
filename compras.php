...
<html lang="en">
    ...
    <script>
        ...
        function update(){
            var precioU = document.getElementById('precio');
            ...
            if (precioU.value.length != "0" && option.value != "" ){
                if(option.value != "0" ){
                    ...
                    var fin = sum * canti.value;
                    document.getElementById('precioF').value = fin;
                }else{
                                ...
                                <div class = "contenido">
                                    ...
                                    <div class="form-group row">
                                        <div class = " col-sm-3">
                                            ...
                                            <select class="form-control" type="text" id="producto" name="producto">
